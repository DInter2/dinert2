...
const Folder = ({ children, title }: {children: ReactNode, title: string }) => {
  ...
  <div className={`lg:w-auto space-y-5 w-[95vw] mx-auto`}>
    ...
    <div className="grid-flow-row-dense bg-white mb-2 pb-10 pt-16 min-h-[70px] shadow-md rounded-lg px-1 md:px-4 grid md:grid-cols-3 xl:grid-cols-4  sm:grid-cols-2 grid-cols-1 gap-10">
     {children}
    </div>
  </div>
