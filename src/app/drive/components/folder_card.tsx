...
export const FolderCard = ({folder}: {folder: Folder}) => (
  <Link href={`/drive/${folder.id}`} scroll={false} className="group/Card block rounded-lg p-6 bg-slate-300 ring-1 ring-slate-900/5 shadow-lg space-y-3 hover:bg-sky-500 hover:ring-sky-500">
    <FcFolder />
