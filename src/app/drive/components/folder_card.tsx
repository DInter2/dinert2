...
export const FolderCard = ({folder}: {folder: FolderDto}) => (
  <Link href={`/drive/${folder.id}`} scroll={false} className="group/Card max-w-xs block rounded-lg p-6 bg-slate-300 ring-1 shadow-lg hover:bg-sky-500 hover:ring-sky-500">
    <FcFolder />
